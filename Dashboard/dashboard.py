...
# Visualisasi (Bar Chart)
fig, ax = plt.subplots(figsize=(12, 6)) # Buat figure dan axes
ax.bar(monthly_rentals.index, monthly_rentals.values, color=sns.color_palette('PuBu_r', len(monthly_rentals)))
